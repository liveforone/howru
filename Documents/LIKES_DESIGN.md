...
[GET] /likes?member-id={memberId}&last-timestamp={lastTimestamp} : 회원에 속한 좋아요, member-id 필수
[GET] /likes?post-id={postId}&last-timestamp={lastTimestamp} : 게시글에 속한 좋아요, post-id 필수
[POST] /likes
