...
object AdvertisementResponse {
    ...
    fun createHalfAdSuccess() = ResponseEntity.status(HttpStatus.CREATED).body(CREATE_HALF_SUCCESS)
    fun createYearAdSuccess() = ResponseEntity.status(HttpStatus.CREATED).body(CREATE_YEAR_SUCCESS)
