...
object AdvertisementResponse {
    fun createHalfAdSuccess() =
        ResponseEntity
            ...
            .body(ResponseMessage.CREATE_HALF_AD_SUCCESS)

    fun createYearAdSuccess() =
        ResponseEntity
            .status(HttpStatus.CREATED)
            .body(ResponseMessage.CREATE_YEAR_AD_SUCCESS)

    fun editAdSuccess() = ResponseEntity.ok(ResponseMessage.EDIT_AD_SUCCESS)

    fun removeAdSuccess() = ResponseEntity.ok(ResponseMessage.REMOVE_AD_SUCCESS)
}
