...
object AdvertisementQuery {
    const val RANDOM_AD_QUERY = "select new howru.howru.advertisement.dto.response.AdvertisementInfo(a.uuid, a.company, a.title, a.content, a.createdDate, a.endDate) from Advertisement a order by RAND() limit 1"
