...
object ReplyResponse {
    fun createReplySuccess() = ResponseEntity.ok(CommandSuccessMessage.CREATE_SUCCESS)

    fun editReplySuccess() = ResponseEntity.ok(CommandSuccessMessage.EDIT_SUCCESS)

    fun removeReplySuccess() = ResponseEntity.ok(CommandSuccessMessage.REMOVE_SUCCESS)
}
