...
interface PostCustomRepository {
    ...
    fun findPostByIdAndWriter(id: Long, writerId: UUID): Post
    fun findPostInfoById(id: Long): PostInfo
    fun findPostsByWriter(memberId: UUID, lastId: Long?): List<PostInfo>
    ...
    fun findRecommendPosts(keyword: String?, lastId: Long?): List<PostInfo>
}