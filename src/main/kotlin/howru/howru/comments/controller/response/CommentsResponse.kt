...
object CommentsResponse {
    fun createCommentsSuccess() =
        ResponseEntity
            ...
            .body(CommandSuccessMessage.CREATE_COMMENTS_SUCCESS)

    fun editCommentsSuccess() = ResponseEntity.ok(CommandSuccessMessage.EDIT_COMMENTS_SUCCESS)

    fun removeCommentsSuccess() = ResponseEntity.ok(CommandSuccessMessage.REMOVE_COMMENTS_SUCCESS)
}
