...
object SubscribeResponse {
    ...
    fun getFollowingSuccess(subscribes: List<SubscribeInfo>) = ResponseEntity.ok(subscribes)
    fun getFollowerSuccess(subscribes: List<SubscribeInfo>) = ResponseEntity.ok(subscribes)
