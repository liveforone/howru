...
object SubscribeResponse {
    fun subscribeSuccess() = ResponseEntity.status(HttpStatus.CREATED).body(CommandSuccessMessage.SUBSCRIBE_SUCCESS)

    fun unsubscribeSuccess() = ResponseEntity.ok(CommandSuccessMessage.UNSUBSCRIBE_SUCCESS)
}
